...
export default function Nosotros() {
  ...
  const razones = [
    { num: '01', kicker: 'Ubicación', titulo: 'Ubicación real', texto: 'Proyectos con acceso pavimentado, cerca de los servicios de la ciudad y rodeados de paisaje abierto: la mezcla justa entre retiro y conexión.' },
    { num: '02', kicker: 'Obra', titulo: 'Hecho para quedarse', texto: 'Urbanismo, vías internas, portería y zonas verdes ejecutados por etapas, con avance de obra verificable en sitio.' },
    { num: '03', kicker: 'Compra', titulo: 'Compra sin fricción', texto: 'Reserva desde $1.000.000, cuotas flexibles sin intereses y acompañamiento jurídico hasta la escrituración.' }
  ];
