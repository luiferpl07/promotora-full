    ...
    <div ref={container} className="bg-[var(--color-pf-navy)]">
      ...
      <main className="overflow-x-hidden font-sans relative z-10 text-[var(--color-pf-bg)]">
        ...
        <section className="relative min-h-[90vh] flex flex-col items-center justify-center pt-32 pb-24 px-8 overflow-hidden">
          ...
          <div className="absolute bottom-12 left-12 flex flex-col items-center gap-4">
             <div className="w-[1px] h-16 bg-white/30"></div>
             <span className="text-[9px] tracking-[0.4em] font-mono uppercase text-white/70" style={{ writingMode: 'vertical-rl' }}>SCROLL</span>
             <svg width="10" height="24" viewBox="0 0 10 24" fill="none" stroke="currentColor" strokeWidth="1" className="opacity-70 text-white"><path d="M5 0 L5 24 M1 20 L5 24 L9 20" /></svg>
          </div>
        </section>
